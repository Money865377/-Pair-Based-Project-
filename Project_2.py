...
duty_cycle = input("If you would like to procede, give me a duity cycle (any number between 0 and 65536): ")

#make sure the number that was given was between 0 and 65536
if duty_cycle >= 0 and duity_cycle <= 65536:
    #if it is, continue
...
while True: 
    if sw5.value():
        ...
        pwm.duty_u16(duty_cycle)        # Set PWM duty cycle
    ...
    if uart.any(): 
        ...
        if data:
            ...
            try:
                ...
                print(f"Received -> Duty Cycle: {duty:.1f}% | PWM: {adc}")
            except:
